...
public class ExpressionParserHelperTest {
	...
	public void testExpressionParserHelperCorrectContentidString() throws ExpressionParserException, ParserException {
		assertTrue(
			"contentid (10001.2) doesn't match",
			ExpressionParserHelper.match("object.contentid == \"10001.2\"", resolvable));
	}
	...
	public void testExpressionParserHelperWrongContentidString() throws ExpressionParserException, ParserException {
		assertFalse(
			...
			ExpressionParserHelper.match("object.contentid == \"10001.1\"", resolvable));
	}

	@Test
	public void testExpressionParserHelperParentCorrectContentidString() throws ExpressionParserException,
			ParserException {
		assertTrue(
			"contentid (10001.1) doesn't match",
			ExpressionParserHelper.match("object.parent.contentid == \"10001.1\"", resolvable));
	}

	@Test
	public void testExpressionParserHelperParentWrongContentidString() throws ExpressionParserException,
			ParserException {
		assertFalse(
			"contentid (10001.2) does match, but it shouldn't",
			ExpressionParserHelper.match("object.parent.contentid == \"10001.2\"", resolvable));
	}
