...
public class CRRequest implements Cloneable, Serializable {
   ...
   * This method is deprecated use {@link CRRequest#setRequest(RequestWrapper)}
   * instead.
  ...
  /**
   * Set the request object.
   * @param requestWrapper RequestWrapper that holds the {@link ServletRequest}
   * or the {@link PortletRequest}
   */
