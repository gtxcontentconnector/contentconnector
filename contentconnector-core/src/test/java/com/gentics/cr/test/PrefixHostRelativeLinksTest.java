...
public class PrefixHostRelativeLinksTest {
	...
	public void testPrefixHostRelativeLinks() {
		...
		assertEquals(
			"Prefixed:<a href=\"http://mein.prefix.host/asdf/blah\">hehe</a>\n",
			RequestProcessor.prefixHostRelativeLinks(
				"Prefixed:<a href=\"/asdf/blah\">hehe</a>\n",
		...
		assertEquals(
			...
			RequestProcessor.prefixHostRelativeLinks(
				...
				"http://mein.prefix.host"));
		assertEquals(
			"Prefixed image:<img alt=\"test\" src=\"http://mein.prefix.host/meinbild.jpg\" />\n",
			RequestProcessor.prefixHostRelativeLinks(
				"Prefixed image:<img alt=\"test\" src=\"/meinbild.jpg\" />\n",
				"http://mein.prefix.host"));
		assertEquals(
			"Prefixed single quote:<a title=\"Test Title\" href='http://mein.prefix.host/mein/relativer/link.html'>testing</a>\n",
			RequestProcessor.prefixHostRelativeLinks(
