...
public class BooleanQuerRewriterTest extends AbstractLuceneTest {
	...
	public void testReplaceTerm() throws ParseException, CorruptIndexException, IOException {
		...
		Query newQuery = BooleanQueryRewriter.replaceTerm(
				orginalQuery,
				new Term(SimpleLucene.CONTENT_ATTRIBUTE, "word1"),
				new Term(SimpleLucene.CONTENT_ATTRIBUTE, "word3"));
	...
	public void testReplaceTerms() throws ParseException, CorruptIndexException, IOException {
		...
		replacements.put(
				...
				new Term(SimpleLucene.CONTENT_ATTRIBUTE, "word3"));
		replacements.put(
				new Term("binarycontent", "word2"),
				new Term("binarycontent", "word9"));
