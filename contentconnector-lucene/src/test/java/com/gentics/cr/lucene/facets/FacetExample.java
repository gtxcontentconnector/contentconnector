package com.gentics.cr.lucene.facets;
...
public class FacetExample {
  ...
  private void index() throws IOException {
    ...
    IndexWriter indexWriter = new IndexWriter(indexDir, new IndexWriterConfig(LuceneVersion.getVersion(), 
        new WhitespaceAnalyzer(LuceneVersion.getVersion())));
  ...
  private List<FacetResult> search() throws IOException {
    ...
    //searcher.search(searcher, new MatchAllDocsQuery(), 10, fc);
    ...
    results.addAll(pubDate.getAllDims(5));
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("-----------------------");
    List<FacetResult> results = new FacetExample().runSearch();
