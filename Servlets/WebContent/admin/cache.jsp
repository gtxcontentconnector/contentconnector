<%--
 ...
 under the License.
--%>
<%-- The Code below is not very pretty. It should be cleaned up  --%>
...
<%
    ...
    Iterator<CacheElementInfo> it = list.iterator();
    while ( it.hasNext() ) {
...
<%
  ...
  Iterator<CacheRegionInfo> itSelect = listSelect.iterator();
