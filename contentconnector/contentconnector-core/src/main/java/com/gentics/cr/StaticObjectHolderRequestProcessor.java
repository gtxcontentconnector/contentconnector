...
/**
 * This is a simple RequestProcessor that just holds a static array of CRResolvables in the JVM. This is especially useful for unit testing classes that work with a RequestProcessor but maybe somebody can use this for other things.
 * @author bigbear3001
 *
 */
public class StaticObjectHolderRequestProcessor extends RequestProcessor {
	 ...
	 * @throws CRException - if no configuration is given, or the PlinkProcessor could not
	 * be initialized.
	 ...
	 */
	public static void setObjects(Collection<CRResolvableBean> newObjects) {
		objects = newObjects;
	}
