...
public class PLinkOutputStreamTest {
	...
	public void testPLOSPerf() throws IOException {
		...
		PortalConnectorHelper.replacePLinks(pTest,
				new PLinkReplacer() {
	...
	public void testPLOS() throws IOException {
		...
		assertEquals("Could not replace plink", "test abc blah  asdfa asdf", testString("test abc blah <plink id=\"100> asdfa asdf"));
