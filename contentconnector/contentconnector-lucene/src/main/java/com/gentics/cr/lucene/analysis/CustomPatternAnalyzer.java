...
public final class CustomPatternAnalyzer extends Analyzer {
  ...
  private static final CharArraySet EXTENDED_ENGLISH_STOP_WORDS =
    CharArraySet.unmodifiableSet(new CharArraySet(LuceneVersion.getVersion(), 
        Arrays.asList(
   ...
   */
  public static final CustomPatternAnalyzer DEFAULT_ANALYZER = new CustomPatternAnalyzer(
    LuceneVersion.getVersion(), NON_WORD_PATTERN, true, StopAnalyzer.ENGLISH_STOP_WORDS_SET);
   ...
   */
  public static final CustomPatternAnalyzer EXTENDED_ANALYZER = new CustomPatternAnalyzer(
		  LuceneVersion.getVersion(), NON_WORD_PATTERN, true, EXTENDED_ENGLISH_STOP_WORDS);
